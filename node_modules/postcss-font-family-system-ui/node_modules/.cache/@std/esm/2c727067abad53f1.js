"main";/*{"e":{"default":1},"m":{"postcss":["default"],"postcss-value-parser":["default"]},"s":[],"w":null}*/let postcss;_aba‍.w('postcss',[["default",function(v){postcss=v}]]);let valueParser;_aba‍.w('postcss-value-parser',[["default",function(v){valueParser=v}]]);
...
_aba‍.d(postcss.plugin('postcss-font-family-system-ui', () => {
  return (root) => {
    root.walk(transform())
  }
}));
